...
mandatory_subscription_channel = '' # هنا هتحط قناتك اشتراك اجباري
BOT_TOKEN = '7563982593:AAGGplxBXFxIqT81SNMr_catVdjkto5hpm4'  # token 
ADMIN_ID = '5761026551'  # id
...
bot_creator = "@™[X]"   # هنا هتحط معرفك علشان يظهر للناس في بدايه البوت 
